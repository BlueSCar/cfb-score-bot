        ...
        onScoreChanged: async (content) => {
            ...
            if (channels.length) {
                ...
                content.status.period >= 4
                    ...
                    (content.awayTeam.score >= content.homeTeam.score && (content.homeTeam.curatedRank - content.awayTeam.curatedRank) >= 10) ||
                    (content.homeTeam.score >= content.awayTeam.score && (content.awayTeam.curatedRank - content.homeTeam.curatedRank >= 10)))) {
