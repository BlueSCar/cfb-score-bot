    ...
    return {
        ...
        onScoreChanged: async (content) => {
            ...
            if ((
                    ...
                    (content.awayTeam.score >= content.homeTeam.score && (content.awayTeam.curatedRank - content.homeTeam.curatedRank) >= 10) ||
                    (content.homeTeam.score >= content.awayTeam.score && (content.homeTeam.curatedRank - content.awayTeam.curatedRank >= 10)))) {
